...
namespace UnityGLTF.Extensions
{
    public static class SchemaExtensions
    {
        ...
        public struct NumericArrayUnity
        {
            [FieldOffset(0)]
            public uint[] AsUInts;
            [FieldOffset(0)]
            ...
            [FieldOffset(0)]
            public GLTF.Math.Vector2[] AsVec2s;
            [FieldOffset(0)]
            public GLTF.Math.Vector3[] AsVec3s;
            [FieldOffset(0)]
            public GLTF.Math.Vector4[] AsVec4s;
            [FieldOffset(0)]
            public GLTF.Math.Matrix4x4[] AsMatrix4x4s;
            [FieldOffset(0)]
            public GLTF.Math.Color[] AsColors;
            [FieldOffset(0)]
            public GLTF.Math.Vector2[] AsTexcoords;
            [FieldOffset(0)]
            public GLTF.Math.Vector3[] AsVertices;
            [FieldOffset(0)]
            public GLTF.Math.Vector3[] AsNormals;
            [FieldOffset(0)]
            public GLTF.Math.Vector4[] AsTangents;

            [FieldOffset(0)]
            public Vector2[] AsUnityVec2s;
            [FieldOffset(0)]
            public Vector3[] AsUnityVec3s;
            [FieldOffset(0)]
            public Vector4[] AsUnityVec4s;
            [FieldOffset(0)]
            public Color[] AsUnityColors;
        }
		...
		public static void ConvertVector3CoordinateSpace(ref AttributeAccessor attributeAccessor, GLTF.Math.Vector3 coordinateSpaceCoordinateScale)
		{
            ...
            if (coordinateSpaceCoordinateScale.X == -1.0f &&
                coordinateSpaceCoordinateScale.Y == 1.0f &&
                coordinateSpaceCoordinateScale.Z == 1.0f)
            {
